...
export default async function OrderConfirmationPage({ params, searchParams }: PageProps) {
  ...
  return (
    <main className="min-h-screen bg-[#020617]">
      {/* Hero — success banner */}
      <section className="bg-[#0f172a] border-b border-slate-800 py-10 px-4">
        <div className="container mx-auto max-w-2xl text-center">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-green-500/20 border border-green-500/30 mb-5">
          ...
          {order.customer_email && (
            <p className="mt-3 text-xs text-slate-500 flex items-center justify-center gap-1.5">
              ...
              Confirmation sent to <span className="font-semibold text-slate-300">{order.customer_email}</span>
            </p>
          )}
        </div>
      </section>
      ...
      <div className="container mx-auto max-w-3xl px-4 py-6 space-y-4">
        ...
        {isCOD && (
          <div className="bg-amber-500/10 border border-amber-500/20 rounded-xl p-4 flex gap-3">
            ...
            <div>
              <p className="font-bold text-amber-300 text-sm">Cash on Delivery Order</p>
              <p className="text-amber-400/80 text-xs mt-1 leading-relaxed">
                A sales representative will call you on{' '}
                <span className="font-semibold text-amber-300">{order.customer_phone}</span> within 1 business day
        ...
        <div className="bg-[#0f172a] rounded-xl border border-slate-800 p-5">
          <h2 className="text-sm font-bold text-slate-300 mb-5">Order Status</h2>
        ...
        <div className="bg-[#0f172a] rounded-xl border border-slate-800 overflow-hidden">
          ...
          {/* Totals */}
          <div className="px-5 py-4 bg-slate-900/50 border-t border-slate-800 space-y-1.5 text-sm">
            ...
            <div className="flex justify-between font-bold text-base text-white pt-2 border-t border-slate-700 mt-2">
          ...
          <div className="bg-[#0f172a] rounded-xl border border-slate-800 p-5 space-y-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-400">
                Estimated <span className="font-semibold text-white">3–7 business days</span>
              </p>
        ...
        {order.razorpay_payment_id && (
          <p className="text-center text-xs text-slate-500">
            Payment Reference:{' '}
            <span className="font-mono font-semibold text-slate-400">{order.razorpay_payment_id}</span>
          </p>
        )}
