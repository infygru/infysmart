      ...
      <div className="container relative z-10 mx-auto px-4 grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <div className="flex flex-wrap gap-4">
            <Link
              href="/contact"
              className="group relative px-8 py-4 bg-[#FF4500] text-white font-bold rounded-lg overflow-hidden shadow-lg shadow-orange-600/25 transition-all hover:scale-105"
            >
              <span className="relative z-10 flex items-center gap-2">
                Get Free Site Survey <ShieldCheck className="w-5 h-5 group-hover:scale-110 transition-transform" />
              </span>
